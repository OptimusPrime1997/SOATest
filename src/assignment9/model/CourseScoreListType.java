...
/**
 * <p>Java class for CourseScoreListType complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="CourseScore" type="{http://jw.nju.edu.cn/schema}CourseScoreType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "CourseScoreListType", propOrder = {
    "courseScore"
})
@XmlRootElement(name="CourseScoreList")
public class CourseScoreListType {

    @XmlElement(name = "CourseScore")
	...
	public void setCourseScore(List<CourseScoreType> courseScore) {
