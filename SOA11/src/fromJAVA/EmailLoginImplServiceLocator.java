...
public class EmailLoginImplServiceLocator extends org.apache.axis.client.Service
		implements fromJAVA.EmailLoginImplService {
	...
	public EmailLoginImplServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName)
			throws javax.xml.rpc.ServiceException {
		super(wsdlLoc, sName);
	}

	// Use to get a proxy class for EmailLoginImplPort
	private java.lang.String EmailLoginImplPort_address = "http://localhost:8081/assignment10/services/EmailLoginPort";
	...
	@Override
	public fromJAVA.EmailLoginImpl getEmailLoginImplPort(java.net.URL portAddress)
			throws javax.xml.rpc.ServiceException {
		try {
			fromJAVA.EmailLoginImplPortBindingStub _stub = new fromJAVA.EmailLoginImplPortBindingStub(portAddress,
					this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (fromJAVA.EmailLoginImpl.class.isAssignableFrom(serviceEndpointInterface)) {
				fromJAVA.EmailLoginImplPortBindingStub _stub = new fromJAVA.EmailLoginImplPortBindingStub(
						new java.net.URL(EmailLoginImplPort_address), this);
				_stub.setPortName(getEmailLoginImplPortWSDDServiceName());
				return _stub;
			}
